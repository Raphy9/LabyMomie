...
void deplacerJoueur(float newPosX, float newPosY) {
  ...
  if (estExterieur) {
    ...
    newPosZ = getTerrainHeight(newPosX, newPosY) / 20.0 + 1.5; // Division par 20 pour convertir en unités du joueur et +0.5 pour élever légèrement le joueur au-dessus du sol
